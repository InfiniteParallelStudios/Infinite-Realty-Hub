    ...
    <ProtectedRoute>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        {[
          ...
          >
            <GlassCard className="h-40 sm:h-48 flex flex-col justify-center items-center text-center p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">
                {widget.title}
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4">
              ...
              <span className="px-3 py-1 bg-primary-500/20 text-primary-600 dark:text-primary-400 rounded-full text-xs sm:text-sm">
                {widget.status}
              </span>
            </GlassCard>
          </motion.div>
